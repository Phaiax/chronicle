...
#ifndef __APPLE__
#ifndef HID_LISTENER_FLUTTER_PLUGIN_EXPORT
#ifdef FLUTTER_PLUGIN_IMPL
#define HID_LISTENER_FLUTTER_PLUGIN_EXPORT PLUGIN_DLLEXPORT
#else
#define HID_LISTENER_FLUTTER_PLUGIN_EXPORT PLUGIN_DLLIMPORT
#endif
#endif
#else
